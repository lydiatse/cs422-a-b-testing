...
// docs.google.com/forms/d/e/1FAIpQLSfBWOIqtWvO4aDrZhMicXlodcOYFkMDMJwGYm1RlNDbufdkug/viewform?vc=0&c=0&w=1&flr=0
function sendNetworkLog(
    ...
    state,
    version) {
    var formid = "e/1FAIpQLSfBWOIqtWvO4aDrZhMicXlodcOYFkMDMJwGYm1RlNDbufdkug";
    var data = {
      "entry.961803644": uid,
      "entry.1893642805": time,
      "entry.2076928494": name,
      "entry.2030848937": target,
      "entry.326336978": info,
      "entry.2121067787": state,
      "entry.1107977100": version
    };
    var params = [];
    for (key in data) {
